...
apk_file_directory = '../../../mnt/storage/yanjie/drebin_goodware'
opseq_file_directory = '../../../mnt/storage/yanjie/drebin_good_opseq'
...
def main():
    ...
    apks = []
    for parent, dirnames, filenames in os.walk(apk_file_directory):
    ...
    for apk_file_location in apks:
        #apk_file_directory: 'small_proto_apks/malware/'
        #apk_hash: apk file name
